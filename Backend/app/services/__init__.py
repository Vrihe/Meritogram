...
from .user_service import create_user, get_user_by_email, authenticate_user, update_user_profile
...
__all__ = [
    ...
    "create_user", "get_user_by_email", "authenticate_user", "update_user_profile",
